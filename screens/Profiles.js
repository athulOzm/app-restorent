...
import {List, ListItem, Text, Left, Right, Icon, Separator} from 'native-base';
...
const Profiles = ({navigation}) => {
    ...
    return (
        <React.Fragment>
        <DHeader navigation={navigation} title="Profiles" />
            ...
            <FlatList 
                ...
                renderItem={({item}) => (
                        ...
                        <ListItem 
                            ...
                            <Left>
                                <Text style={css.font}>{item.employee_name}</Text>
                            </Left>
                            <Right>
